...
struct RBDL_DLLAPI ConstraintSet {
	...
	std::vector<Math::SpatialForce> f_t;
	/// Workspace for the actual spatial forces.
	std::vector<Math::SpatialForce> f_ext_constraints;
